          ...
          for number, vehicle_hash in product_hash[:options]
            ...
            for make_name, model_hash in vehicle_hash
              ...
              for model_name, year_hash in model_hash
                ...
                model ||= VehicleModel.create(:name => model_name, :vehicle_make_id => make.id)
